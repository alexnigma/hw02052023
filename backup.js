...
let meterString = String(meter);

meterString.charAt(meterString.length-1);


if (meterString.endsWith(1) && kMeter < 1000) {
    console.log(meter + " метр" + " це " + kMeter + " кілометра")
} else if (meterString.endsWith(2) || meterString.endsWith(3) || meterString.endsWith(4)) {
    console.log(meter + " метра" + " це " + kMeter + " кілометра")
} else {
    console.log(meter + " метрів" + " це " + kMeter + " кілометрів")
};
